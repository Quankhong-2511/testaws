# Generated by Django 4.2.3 on 2023-08-08 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diem_tb', models.FloatField(max_length=10)),
                ('image', models.ImageField(default=None, upload_to='qlsv/%Y/%m')),
                ('xep_hang', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='quanly.xephang')),
            ],
        ),
        migrations.CreateModel(
            name='User',
